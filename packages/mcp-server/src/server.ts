...
import { ClientOptions } from 'bem-ai';
...
export { ClientOptions } from 'bem-ai';
...
export function initMcpServer(params: {
  ...
  const client = new BemSDK(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new BemSDK({ environment: (readEnv('BEM_SDK_ENVIRONMENT') || undefined) as any });
