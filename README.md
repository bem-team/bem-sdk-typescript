...
[![NPM version](https://img.shields.io/npm/v/bem-sdk.svg)](https://npmjs.org/package/bem-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/bem-sdk)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/bem-sdk-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install bem-sdk`
...
1. Via the `BEM_SDK_LOG` environment variable
...
const client = new BemSDK({
  logger: logger.child({ name: 'BemSDK' }),
...
```ts
import BemSDK from 'npm:bem-sdk';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/bem-sdk-typescript/issues) with questions, bugs, or suggestions.
