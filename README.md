...
```sh
npm install git+ssh://git@github.com:bem-team/bem-sdk-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/bem-team/bem-sdk-typescript/issues) with questions, bugs, or suggestions.
